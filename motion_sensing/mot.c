...
// Date: 6/24/15
// Some starter Code taken from Arduino MPU-6050 site
// (alot of #defines for register labels)
...
void loop()
{
  ...
  */
  ...
  cmps.value.x_cmps = MPU9150_readSensor(MPU9150_CMPS_XOUT_L,MPU9150_CMPS_XOUT_H);
  cmps.value.y_cmps = MPU9150_readSensor(MPU9150_CMPS_YOUT_L,MPU9150_CMPS_YOUT_H);
  cmps.value.z_cmps = MPU9150_readSensor(MPU9150_CMPS_ZOUT_L,MPU9150_CMPS_ZOUT_H);
